...
class PostController extends BaseController
{
    ...
    {
        parent::__construct();
        $this->blogPostRepository = app(BlogPostRepository::class); //app вертає обєкт класа
    ...
    public function update(BlogPostUpdateRequest $request, $id)
    {
        ...
        $result = $item->update($data); //оновлюємо дані обєкта і зберігаємо в БД
    ...
    public function destroy($id)
    {
        ...
        if ($result) {BlogPostAfterDeleteJob::dispatch()->delay(20);
            return redirect()
